...
import com.android.example.navigationdemo2.databinding.FragmentQuestionBinding
...
class QuestionFragment : Fragment() {
    ...
    private val questions : MutableList<Question> =mutableListOf(
            Question(
                text = "Which Order have been implemented by Malaysia goverment to prevent COVID-19?",
                answer=listOf(
